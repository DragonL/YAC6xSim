...
#define JIT_APPLY_RETURN_FLOAT_AS_NFLOAT 1
#define JIT_APPLY_RETURN_DOUBLE_AS_NFLOAT 1
...
typedef union
{
	...
	struct { jit_ubyte pad[8]; jit_nfloat f_value; } float_value;
	struct { jit_ubyte pad[8]; jit_nfloat f_value; } double_value;
	struct { jit_ubyte pad[8]; jit_nfloat f_value; } nfloat_value;
...
#define jit_apply_return_set_float32(result,value)	\
	(((result)->float_value.f_value) = ((jit_nfloat)(value)))
#define jit_apply_return_set_float64(result,value)	\
	(((result)->double_value.f_value) = ((jit_nfloat)(value)))
